    ...
    <div class="validation">
        <div class="card">
            <div class="header">
                ...
                <div class="content">
                    <span class="title">Message envoyé</span>
                    <p class="message">Merci de nous avoir contacter. Nous faisons notre maximum pour écourter votre attente et vous répondre
                        sous les plus bref délais.</p>
                </div>
            </div>
        </div>
    </div>
