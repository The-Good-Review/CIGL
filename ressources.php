...
$emplois = json_decode(
    file_get_contents("content/emplois.json"),
    true
);
    ...
    <div class="page">
        ...
        <div class="postes">
            <section class="articles" id="jobList" aria-label="Liste des postes vacants">
                <a style="text-decoration: none;" class="preslink" href="jobPages/assistantAdministratif.php">
                    <article class="article-card">
                        <div class="article-body">
                            <h3><?= $emplois['offre1']['poste'] ?></h3>
                            <p class="article-desc"><?= $emplois['offre1']['description'] ?>
                            </p>
                            <div class="article-meta">
                                ...
                                <span class="tag tag-green"><?= $emplois['offre1']['contrat'] ?></span>
                            </div>
                        </div>
                        ➜
                    </article>
                ...
                <a style="text-decoration: none;" class="preslink" href="jobPages/educateurDiplome.php">
                    <article class="article-card">
                        <div class="article-body">
                            <h3><?= $emplois['offre2']['poste'] ?></h3>
                            <p class="article-desc"><?= $emplois['offre2']['description'] ?></p>
                            <div class="article-meta">
                                <span class="article-date">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2">
                                ...
                                <span class="tag tag-blue"><?= $emplois['offre2']['contrat'] ?></span>
                            </div>
                        </div>
                        ➜
                    </article>
                ...
                <a style="text-decoration: none;" class="preslink" href="jobPages/mecanicienVelo.php">
                    <article class="article-card">
                        <div class="article-body">
                            <h3><?= $emplois['offre3']['poste'] ?></h3>
                            <p class="article-desc"><?= $emplois['offre3']['description'] ?></p>
                            <div class="article-meta">
                                <span class="article-date">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2">
                                ...
                                <span class="tag tag-orange"><?= $emplois['offre3']['contrat'] ?></span>
                            </div>
                        </div>
                        ➜
                    </article>
