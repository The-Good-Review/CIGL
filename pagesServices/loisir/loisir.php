...
<head>
    ...
    <title>Loisir & Tourisme - CIGL ESCH ASBL</title>
...
<body>
    ...
    <div class="imageAcceuil">
        <div>
            ...
            <h1>Pour vos loisir, <br> vos découvertes.</h1>
            <h3>Nous vous proposons des activité et séjours <br> pour se divertir, apprendre et s'évader.</h3>
        </div>
        <img src="../../img/accueil-service/camp.JPG" alt="">
    </div>
    <br>
    <div class="grey-back">
        <div class="infos-service-container">
            <div class="infos-service">
                ...
                <p class="info-service-text"><b>Pour qui ?</b> <br> Toute personne ou groupe souhaitants découvrir le territoir autrement.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/objectif-orange.png">
                <p class="info-service-text"><b>Notre objectif</b> <br> Proposer des activités et des lieux de séjours favorisant le lien social et la découverte.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/alliance-orange.png">
                <p class="info-service-text"><b>Notre engagement</b> <br> Rendre les loisirs accessible au plus grand nombre dans un esprit de convivialité.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/approche-orange.png">
                <p class="info-service-text"><b>Notre approche</b> <br> Des activités inclusives, encadrées et ouvertes à tous favorisant les rencontre et le partage.</p>
            </div>
        </div>
        <br><br>
        ...
        <div class="services">
            <div class="services-grid dos">
                <a class="services-link" href="stuff.php">
                    <div class="services-cards">
                        <img src="../../img/icons/services/barbecue.png">
                        <p>Brasserie Camping's Stuff</p>
                        <p class="fleche orange">➞</p>
                    </div>
                </a>
                <a class="services-link" href="rosati.php">
                    <div class="services-cards">
                        <img src="../../img/icons/services/maison-jardin.png">
                        <p>Maison Rosati</p>
                        <p class="fleche orange">➞</p>
                    </div>
                </a>
