...
$dossier = __DIR__ . '/../../content/actualitesFamille/mobilite/';
...
<head>
    ...
    <title>Mobilité - CIGL ESCH ASBL</title>
...
<body>
    ...
    <div class="imageAcceuil">
        <div>
            <h2 class="bleu">MOBILITE</h2>
            <h1>Pour vous déplacer, <br> avec plus de facilité.</h1>
        ...
        <img src="../../img/accueil-service/velo.jpg" alt="">
    </div>
    <br>
    <div class="grey-back">
        <div class="infos-service-container">
            <div class="infos-service">
                ...
                <p class="info-service-text"><b>Pour qui ?</b> <br> Tous les haitants d'Esch-sur-Alzette, Bettembourg, Differdange, Dudelange, Sanem et Schifflange.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/objectif-bleu.png">
                <p class="info-service-text"><b>Notre objectif</b> <br> Vous aider déplacer plus facilement et écologiquement pour les activités du quotidiens.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/alliance-bleu.png">
                <p class="info-service-text"><b>Notre engagement</b> <br> Favoriser une mobilité accessible, solidaire et adaptée aux besoins de chacun.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/approche-bleu.png">
                <p class="info-service-text"><b>Notre approche</b> <br> Des solutions simples humaines et personalisées pour préserver l'autonomie des usagers.</p>
            </div>
        </div>
        <br><br>
        ...
        <div class="services">
            <div class="services-grid uno">
                <a class="services-link" href="https://www.velok.lu/" target="_blank">
