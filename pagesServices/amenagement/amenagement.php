...
<head>
    ...
    <title>Amenagement & Travaux - CIGL ESCH ASBL</title>
...
<body>
    ...
    <div class="imageAcceuil">
        <div>
            ...
            <h1>Pour des espaces <br> adaptés à tous</h1>
            <h3>Nous aménageons et entretenons des aménagements <br> utiles, durables et accessibles à chacun.</h3>
        </div>
        <img src="../../img/accueil-service/travaux.jpg" alt="">
    </div>
    <br>
    <div class="grey-back">
        <div class="infos-service-container">
            <div class="infos-service">
                ...
                <p class="info-service-text"><b>Pour qui ?</b> <br> Collectivités, associations, entreprises et habitant ayant besoin d'aménagements ou de travaux extérieur.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/objectif-bleu.png">
                <p class="info-service-text"><b>Notre objectif</b> <br> Créer entretenir ou améliorer les espaces publics et les infrastructures de proximité.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/alliance-bleu.png">
                <p class="info-service-text"><b>Notre engagement</b> <br> Réaliser des interventions de qualité utiles à la collectivité et au quotidien des habitants.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/approche-bleu.png">
                <p class="info-service-text"><b>Notre approche</b> <br> Un travail soigné, durable et réalisé avec des engagées dans une démarche d'insertion.</p>
            </div>
        </div>
        <br><br>
        ...
        <div class="services">
            <div class="services-grid dos">
                <a class="services-link" href="entretien.php">
                ...
                <a class="services-link" href="construction.php">
                    <div class="services-cards">
                        <img src="../../img/icons/services/grue.png">
