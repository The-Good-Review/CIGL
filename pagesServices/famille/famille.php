...
$dossier = __DIR__ . '/content/actualitesFamille/famille';
...
<head>
    ...
    <title>Famille & enfant - CIGL ESCH ASBL</title>
...
<body>
    ...
    <div class="imageAcceuil">
        <div>
            <h2 class="orange">FAMILLE & ENFANT</h2>
            <h1>Pour bien grandir, <br> ensemble.</h1>
            <h3>Nous accompagnons les familles à chaque étape de la vie pour <br> favoriser l'épanouissement des enfants et le bien-être de tous.</h3>
        </div>
        <img src="../../img/accueil-service/enfants.jpg" alt="">
    </div>
    <br>
    <div class="grey-back">
        <div class="infos-service-container">
            <div class="infos-service">
                <img src="../../img/icons/stats/person.png">
                <p class="info-service-text"><b>Pour qui ?</b> <br> Toutes les familles d'Esch-sur-Alzette, avec des enfants de 0 à 12 ans.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/objectif-orange.png">
                <p class="info-service-text"><b>Notre objectif</b> <br> Vous accompagner dans l'éducation et vous aider à reprendre le contrôle de votre quotidien</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/alliance-orange.png">
                <p class="info-service-text"><b>Notre engagement</b> <br> Des services accessibles, bienveillants et adaptés à vos besoins.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="infos-service">
                <img src="../../img/icons/services/approche-orange.png">
                <p class="info-service-text"><b>Notre approche</b> <br> Ecoute, proximité et collaboration avec nos équipes locales.</p>
            </div>
        </div>
        <br><br>
        ...
        <div class="services">
            <div class="services-grid">
                <a class="services-link" href="https://www.heemelmaus.lu/qui-sommes-nous-creche-belval/" target="_blank">
                    <div class="services-cards">
                        <img src="../../img/icons/services/poussette.png">
                        <p>Crèche Belval</p>
                        <p class="fleche orange">➞</p>
                    </div>
                </a>
                <a class="services-link" href="https://heemelmaus.lu/qui-sommes-nous-accueil-educatif/" target="_blank">
                    <div class="services-cards">
                        <img src="../../img/icons/services/eleves.png">
                        <p>Accueil Educatif</p>
                        <p class="fleche orange">➞</p>
                    </div>
                </a>
                <a class="services-link" href="https://www.heemelmaus.lu/qui-sommes-nous-maison-relais/" target="_blank">
                    <div class="services-cards">
                        <img src="../../img/icons/services/maison-orange.png">
                        <p>Maison Relai</p>
                        <p class="fleche orange">➞</p>
                    </div>
                </a>
