...
<body>
    ...
    <div class="page">
        ...
        <div class="postes">
            <p class="presP">Nous recrutons un(e) Éducateur(trice) diplômé(e) afin d'accompagner les enfants dans leur
                développement, leur épanouissement et leur autonomie au sein d'une équipe pluridisciplinaire.</p>
            <p class="presP">Vous contribuerez à la mise en œuvre de projets éducatifs favorisant le bien-être, la
                socialisation et le développement de chaque enfant.</p>
            <br>
            <p class="presP"><b>Vos missions :</b>
            <ul class="presP">
                <li>Accueillir et accompagner les enfants au quotidien.</li>
                <li>Concevoir et animer des activités éducatives, culturelles et ludiques.</li>
                <li>Veiller à la sécurité physique, affective et psychologique des enfants.</li>
                <li>Observer le développement des enfants et assurer un suivi individualisé.</li>
                <li>Participer à l'élaboration des projets pédagogiques.</li>
                <li>Collaborer avec les familles et les partenaires éducatifs.</li>
                <li>Travailler en équipe afin de garantir une prise en charge de qualité.</li>
                <li>Participer aux réunions et formations internes.</li>
            </ul>
            </p>
            <br>
            <p class="presP"><b>Profil recherché :</b>
            <ul class="presP">
                <li>Diplôme d'État d'Éducateur ou diplôme équivalent reconnu.</li>
                <li>Expérience auprès d'enfants appréciée.</li>
                <li>Sens des responsabilités.</li>
                <li>Patience, écoute et bienveillance.</li>
                <li>Capacité à travailler en équipe.</li>
                <li>Créativité et esprit d'initiative.</li>
            </ul>
            </p>
            <br>
        ...
        <form action="../php/mail3.php" method="POST" enctype="multipart/form-data" id="candidature-form">
            <input type="hidden" name="poste" value="Educateur Diplome">
            <fieldset>
