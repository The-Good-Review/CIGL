...
<body>
    ...
    <div class="page">
        ...
        <div class="postes">
            <p class="presP">Afin de renforcer notre atelier, nous recherchons un(e) Mécanicien(ne) vélo chargé(e)
                d'assurer l'entretien, la réparation et la préparation des vélos tout en accompagnant les utilisateurs
                dans leur utilisation et leur maintenance.</p>
            <p class="presP">Vous participerez activement à la qualité du service proposé et à la satisfaction de nos
                clients.</p>
            <br>
            <p class="presP"><b>Vos missions :</b>
            <ul class="presP">
                <li>Diagnostiquer les pannes mécaniques.</li>
                <li>Réaliser les opérations d'entretien courant.</li>
                <li>Effectuer les réparations et le remplacement des pièces défectueuses.</li>
                <li>Préparer les vélos avant leur mise à disposition ou leur vente.</li>
                <li>Contrôler la conformité et la sécurité des vélos.</li>
                <li>Conseiller les utilisateurs sur l'entretien et les bonnes pratiques.</li>
                <li>Gérer le stock de pièces détachées et consommables.</li>
                <li>Maintenir un atelier propre, organisé et sécurisé.</li>
            </ul>
            </p>
            <br>
            <p class="presP"><b>Profil recherché :</b>
            <ul class="presP">
                <li>Formation en mécanique cycle ou expérience équivalente.</li>
                <li>Bonne connaissance des différents types de vélos et composants.</li>
                <li>Maîtrise des techniques de diagnostic et de réparation.</li>
        ...
        <form action="../php/mail3.php" method="POST" enctype="multipart/form-data" id="candidature-form">
            <input type="hidden" name="poste" value="Mecanicien Velo">
            <fieldset>
